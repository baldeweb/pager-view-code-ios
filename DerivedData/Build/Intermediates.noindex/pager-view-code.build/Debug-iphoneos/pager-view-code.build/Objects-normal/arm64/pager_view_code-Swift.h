...
#ifndef PAGER_VIEW_CODE_SWIFT_H
#define PAGER_VIEW_CODE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pager_view_code",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15pager_view_code11AppDelegate")
...
SWIFT_CLASS("_TtC15pager_view_code6Button")
...
SWIFT_CLASS("_TtC15pager_view_code10PageButton")
@interface PageButton : Button
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15pager_view_code18PageViewController")
...
SWIFT_CLASS("_TtC15pager_view_code19PagerViewController")
@interface PagerViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)handlePanGestureWithGesture:(UIPanGestureRecognizer * _Nonnull)gesture;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC15pager_view_code13SceneDelegate")
...
SWIFT_CLASS("_TtC15pager_view_code14ViewController")
